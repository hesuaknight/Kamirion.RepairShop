...
namespace Kamirion.RepairShop.Infrastructure.Migrations
{
    ...
    [Migration("20260516144021_AddNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kamirion.RepairShop.Communication.Domain.MessageTemplate", b =>
                {
                    ...
                    b.HasIndex("TenantId", "TemplateKey", "Channel", "Culture")
                        .IsUnique()
            ...
            modelBuilder.Entity("Kamirion.RepairShop.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
            ...
            modelBuilder.Entity("Kamirion.RepairShop.Infrastructure.Identity.SecurityAuditLog", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("nvarchar(26)");
            ...
            modelBuilder.Entity("Kamirion.RepairShop.Notifications.Domain.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("nvarchar(26)");
            ...
            modelBuilder.Entity("Kamirion.RepairShop.Search.Domain.SearchIndexEntry", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("nvarchar(26)");
            ...
            modelBuilder.Entity("Kamirion.RepairShop.Tenancy.Domain.Tenant", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("nvarchar(26)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Kamirion.RepairShop.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
